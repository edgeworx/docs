...
[//]: # '| `container.ports.public`                 | This is a specialized field that exposes a `public` port to the internet at large. Setting this port allows the URL to map directly to the internal port outside of the microservice. See [Port Broker]({{<ref "public-services.md">}}) for a more detailed explanation of the public section.                                                                                                                                                                                                    |
