...
| `container.rootHostAccess` | This variable is the same as the `privilege` mode on Docker; when it is set to true, the container will be able to access the `host`. This will also set the network of the container to host. See the [Docker to Edgeworx]({{<ref "docker-to-darcy.md">}}) section for a more detailed explanation about this field.                                                                                                                                                                                    |
| `container.ports`          | List of port mapping to be provided to the container running the microservice. See the [Docker to Edgeworx]({{<ref "docker-to-darcy.md">}}) section for a more detailed explanation about this field.                                                                                                                                                                                                                                                                                                    |
...
| `container.volumes`                      | List of volume mapping to be provided to the container running the microservice. See the [Docker to Edgeworx]({{<ref "docker-to-darcy.md">}}) section for a more detailed explanation about this field.                                                                                                                                                                                                                                                                                                  |
