...
You should have completed the steps in the [Packaging Guide]({{<ref "package.md">}}) by now. If have not,
...
the [Build Guide](./BUILD.md) at port 3456 then you should be able to view the live feed using the
