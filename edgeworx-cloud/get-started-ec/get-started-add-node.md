...
## 2. Run the Node Installation Script

Enter a shell environment for the host you wish to install the Edgeworx Agent on.

Paste the command that you copied in step 2 into the terminal. Hit enter. If an error occurs, the terminal output will indicate how to view the logs.

## 3. View the Node on Edgeworx Cloud Portal
